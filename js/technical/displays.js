function prestigeButtonText(layer) {
	...
	if (tmp[layer].type == "normal")
		return `${player[layer].points.lt(1e3) ? (tmp[layer].resetDescription !== undefined ? tmp[layer].resetDescription : langData[options.lang].system.prestige.resetFor + " ") : ""}+<b>${formatWhole(tmp[layer].resetGain)}</b> ${tmp[layer].resource}${player[layer].points.lt(1e3) ?  (langData[options.lang].postposition ? tmp[layer].objectivePostposition : "") + langData[options.lang].system.prestige.resetForAfter : ""}${tmp[layer].resetGain.lt(100) && player[layer].points.lt(1e3) ? (`<br><br>${langData[options.lang].system.prestige.nextAt} ${(tmp[layer].roundUpCost ? formatWhole(tmp[layer].nextAt) : format(tmp[layer].nextAt))} ${tmp[layer].baseResource} ${langData[options.lang].system.prestige.nextAtAfter}`) : ""}`
	if (tmp[layer].type == "static")
		return `${tmp[layer].resetDescription !== undefined ? tmp[layer].resetDescription : langData[options.lang].system.prestige.resetFor + " "}+<b>${formatWhole(tmp[layer].resetGain)}</b> ${tmp[layer].resource + (langData[options.lang].postposition ? tmp[layer].objectivePostposition : "") + langData[options.lang].system.prestige.resetForAfter}<br><br>${player[layer].points.lt(30) ? (tmp[layer].baseAmount.gte(tmp[layer].nextAt) && (tmp[layer].canBuyMax !== undefined) && tmp[layer].canBuyMax ? langData[options.lang].system.prestige.next : langData[options.lang].system.prestige.req) : ""} ${formatWhole(tmp[layer].baseAmount)} / ${(tmp[layer].roundUpCost ? formatWhole(tmp[layer].nextAtDisp) : format(tmp[layer].nextAtDisp))} ${tmp[layer].baseResource} ${player[layer].points.lt(30) ? (tmp[layer].baseAmount.gte(tmp[layer].nextAt) && (tmp[layer].canBuyMax !== undefined) && tmp[layer].canBuyMax ? langData[options.lang].system.prestige.nextAfter : langData[options.lang].system.prestige.reqAfter) : ""}		
		`
...
function challengeButtonText(layer, id) {
    return (player[layer].activeChallenge==(id)?(canCompleteChallenge(layer, id)?langData[options.lang].system.challenge.finish:langData[options.lang].system.challenge.exitEarly):(hasChallenge(layer, id)?langData[options.lang].system.challenge.completed:langData[options.lang].system.challenge.start))
